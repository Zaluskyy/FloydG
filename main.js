...
image.src = "img/skin/skin4R.png";

const monsterImageR = new Image();
monsterImageR.src = "img/monster/monster3R.png"
const monsterImageL = new Image();
monsterImageL.src = "img/monster/monster3L.png"
    ...
    constructor(monsterXL, monsterXR, monsterYL, monsterYR) {
        ...
        this.update = () => {
            ...
            if (this.leftL) {
                ...
                monsterImageL.src = "img/monster/monster3R.png"
            } else {
                this.monsterXL += monster.speed
                monsterImageL.src = "img/monster/monster3L.png"
            }
            ...
            if (this.leftR) {
                ...
                this.monsterXR += monster.speed
                monsterImageR.src = "img/monster/monster3L.png"
            }
